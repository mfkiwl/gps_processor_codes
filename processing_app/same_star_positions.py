...
def format_time(recv_time):                       # csak 2020, 1, 12 utani adatokra mukodik
  ...
  month = 8                                       #adjust acording to the current month
  first_day_of_week = 30                          #adjust acording to the first day of the curent week
  #----------------------------------------------------------------------------------------------=
  #----------------------------------------------------------------------------------------------=
...
def process_one(directory):
  ...
  if obs_file:
    ...
    # S2 = 91262  # Vega
    # star_names=["Mirphak", "Vega"]
    # get_stars_position_in_time(rinex_processed_grouped, generalinfo_path, 87, S1_=S1, S2_=S2, star_names=star_names)
    # S1 = 57632  # Denebola
    # S2 = 109074  # Sadalmelik
    # star_names=["d", "s"]
    # get_stars_position_in_time(rinex_processed_grouped, generalinfo_path, 87, S1_=S1, S2_=S2, star_names=star_names)
...
root_directory = "/Users/kelemensz/Documents/Research/GPS/process/24h/januar_5_12"
...
directory = "/Users/kelemensz/Documents/Research/GPS/process/24h/RO/cmap/sept2_3_cluj"

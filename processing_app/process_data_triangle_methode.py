  ...
  for obs_file in obs_files:
    ...
    if len(obs_file_name) == 12:  
      ...
      try:
        ...
        # #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++      A +-ok KOZTI RESZT KI KELL TORULNI!!!!!!!!!!!!!!!!!!!!
...
def comments():
  ...
  # obs_path = r"/Users/kelemensz/Qsync/GPS/reciever_data/perth_data/done_2/januar"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/januar"

  # obs_path = r"/Users/kelemensz/Documents/Research/GPS/process/triangular_method/raw_data/januar"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/process_NZLD/januar"

  # obs_path = r"/Users/kelemensz/Documents/Research/GPS/process/triangular_method/raw_data/november"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/triangular_method"

  # obs_path = r"/Users/kelemensz/Qsync/GPS/reciever_data/perth_data/done/december"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/december2019"

  # obs_path = r"/Users/kelemensz/Qsync/GPS/reciever_data/perth_data/done_2/junius"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/junius"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/PERTH/rinex_obs/aprilis"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/aprilis"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/PERTH/rinex_obs/majus"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/majus"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/NZ/obs_files/ARTA/oktober"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/process_NZLD/oktober"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/PERTH/rinex_obs/februar"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/februar"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/PERTH/rinex_obs/julius/to_process"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/julius"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/NZ/obs_files/ARTA/januar"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/process_NZLD/januar"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/PERTH/rinex_obs/januar"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements/januar"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/NZ/obs_files/ARTA/februar"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/process_NZLD/februar"

  # obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/NZ/obs_files/ARTA/aprilis"
  # destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/process_NZLD/aprilis"




#                                             PERTH
obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/PERTH/rinex_obs/szeptember"
destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/PERTH_daily_measurements"

                                            # NZLD
# obs_path = r"/Volumes/ADATA SE800/GPS/raw_data/NZ/obs_files/ARTA_smaller_obs/junius"
# destination_path = r"/Users/kelemensz/Documents/Research/GPS/process/global_GCS_axis/process_NZLD"


                                            # HKKS
# obs_path = r"/Users/kelemensz/Documents/Research/GPS/obs_files/CHKG/december2020"
...
month_names = ["julius", "szeptember", "februar", "marcius", "augusztus", "januar", "december2019", "oktober", "november", "majus", "aprilis" , "junius", "december2020"]
